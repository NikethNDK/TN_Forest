      ...
      <div className="px-4 sm:px-6">
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            <div className="mb-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary-dark via-primary-main to-accent-dark mb-6">
            ...
            <div className="max-w-3xl mx-auto mb-8 space-y-6">
              <div className="bg-background-paper rounded-lg shadow-md p-6 border-l-4 border-r-4 border-border-primary">
                ...
                <p className="text-content-primary leading-relaxed text-sm sm:text-base">
          ...
          <div className="bg-gradient-to-br from-primary-lightest to-primary-lighter shadow-xl rounded-2xl p-6 border-l-8 border-primary-main ring-1 ring-border-lightest">
            <h2 className="text-xl sm:text-2xl font-bold text-content-heading mb-6 flex items-center">
              <span className="w-2 h-6 sm:h-8 bg-accent-light mr-3"></span>
              Recent Events
            </h2>
          ...
          {/* Latest News - Mobile */}
          <div className="bg-gradient-to-bl from-primary-lightest to-primary-lighter shadow-xl rounded-2xl p-6 border-r-8 border-accent-dark ring-1 ring-border-lightest">
            <h2 className="text-xl sm:text-2xl font-bold text-content-heading mb-6 flex items-center justify-end">
              Latest News
              <span className="w-2 h-6 sm:h-8 bg-primary-main ml-3"></span>
            </h2>
            <div className="max-h-80">
