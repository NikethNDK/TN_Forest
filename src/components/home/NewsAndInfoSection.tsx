...
const NewsAndInfoSection: React.FC<NewsAndInfoSectionProps> = ({ latestNews, events }) => {
  ...
  return (
    <section className="py-8 md:py-12 bg-background-home-body">
      <div className="px-4 sm:px-6">
        ...
        <div className="space-y-8">
          ...
          <div className="text-center py-16 px-4 lg:px-8 leaf-pattern rounded-2xl max-w-4xl mx-auto" style={{ backgroundColor: '#ededed' }}>
            ...
            <p className="text-lg sm:text-xl text-home-text leading-relaxed mb-6 max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-home-text-secondary leading-relaxed mb-8 max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-left max-w-3xl mx-auto">
              <div className="bg-mission-vision-card-bg rounded-xl p-6 shadow-soft border border-border-default hover:shadow-elevated transition-all duration-300 group hover:-translate-y-1">
                ...
                <p className="text-home-text-secondary leading-relaxed text-sm sm:text-base">
